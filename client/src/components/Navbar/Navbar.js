...
import logo from "../../assets/vinm.jpg";
import "./Navbar.scss";
      ...
      <div className="container-fluid">
        ...
        >
          <div className="navbar-nav first justify-content-center">
            ...
            <Link to="/AboutUS" className="nav-item nav-link text-uppercase mx-1">
              AboutUS
            </Link>
            <Link to="/Ourteam" className="nav-item nav-link text-uppercase mx-1">
              OUR TEAM
            </Link>
